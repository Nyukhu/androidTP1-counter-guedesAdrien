...
public class CalcActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        binding.toastButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(CalcActivity.this, binding.counter.toString(), Toast.LENGTH_SHORT).show();
            }
        });
        binding.computeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(CalcActivity.this, Double.toString(calcResult),Toast.LENGTH_SHORT).show();
